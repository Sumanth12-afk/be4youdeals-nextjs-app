...
function AuthFormContainer({ 
  ...
  onGoogleSignIn?: () => void;
    ...
    return (
        <div className="mx-auto grid w-[350px] gap-2 relative">
            {/* Floating Brand Logo with Effects */}
            <div className="absolute -top-32 left-1/2 transform -translate-x-1/2 z-20 animate-pulse">
                <div className="relative group">
                    {/* Glow Effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-400/20 to-cyan-400/20 rounded-3xl blur-xl scale-110 group-hover:scale-125 transition-all duration-500"></div>
                    
                    {/* Main Logo Container */}
                    <div className="relative bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl rounded-3xl p-6 border border-white/30 shadow-2xl group-hover:shadow-orange-500/25 transition-all duration-500 hover:scale-105">
                        {/* Animated Border */}
                        <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-orange-400 via-cyan-400 to-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-gradient-x"></div>
                        <div className="absolute inset-[1px] rounded-3xl bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl"></div>
                        
                        {/* Logo Image */}
                        <div className="relative z-10">
                            <img 
                                src="/Vibrics Deals Logo.png" 
                                alt="Vibrics Deals Logo" 
                                className="h-20 w-auto object-contain drop-shadow-2xl group-hover:drop-shadow-orange-500/50 transition-all duration-500"
                            />
                        </div>
                        
                        {/* Floating Particles */}
                        <div className="absolute -top-2 -left-2 w-2 h-2 bg-orange-400 rounded-full animate-ping opacity-75"></div>
                        <div className="absolute -bottom-2 -right-2 w-1.5 h-1.5 bg-cyan-400 rounded-full animate-ping opacity-75 animation-delay-1000"></div>
                    </div>
                </div>
            </div>
            ...
            <Button variant="outline" type="button" onClick={onGoogleSignIn || (() => console.log("UI: Google button clicked"))}>
