...
import { allHeadphonesIndia } from "../../../../all-headphones-india-data";
...
export default function IndiaHeadphonesPage1() {
  const [filteredProducts, setFilteredProducts] = useState(allHeadphonesIndia);
  ...
  const handleFiltersChange = (filtered: typeof allHeadphonesIndia) => {
  ...
  return (
    <>
      <Head>
        <title>Headphones - Vibrics Deals India</title>
        <meta name="description" content="Premium audio devices and headphones at unbeatable prices in India. Premium headphones with INR pricing." />
      ...
      <main className="relative z-10 px-6 py-24">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-6">
            Premium audio devices and headphones at unbeatable prices in India
          </p>
          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
            <span className="text-cyan-400 font-semibold mr-2">🇮🇳 India Region</span>
            <span className="text-gray-400">•</span>
            <span className="text-white ml-2">{allHeadphonesIndia.length} Products Available</span>
          </div>
        </motion.div>
