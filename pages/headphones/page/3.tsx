...
import { allHeadphonesExtended } from "../../../all-headphones-data";
...
export default function HeadphonesPage3() {
  const [headphones] = useState(allHeadphonesExtended);
  const [filteredProducts, setFilteredProducts] = useState(allHeadphonesExtended);
  ...
  return (
    <>
      <Head>
        <title>Headphones - Vibrics Deals</title>
        <meta name="description" content="Discover the best headphone deals with massive savings. Premium headphones at unbeatable prices." />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 relative overflow-hidden">
        ...
        <main className="relative z-10 px-6 py-24">
          ...
          >
            ...
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
              ...
              <span className="text-white ml-2">{allHeadphonesExtended.length} Products Available</span>
            </div>
          </motion.div>
          ...
          >
            <AdvancedFilters
              products={allHeadphonesExtended}
        ...
        <ProgressIndicator
          isLoading={isLoading}
          message="Loading enhanced headphone experience..."
          type="spinner"
          fullScreen={true}
        />
      </div>
